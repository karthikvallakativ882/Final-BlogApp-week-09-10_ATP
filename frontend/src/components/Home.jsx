      ...
      >
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            <img
              src="https://tse2.mm.bing.net/th/id/OIP.TmroOmscV9SzqQHWIYGZVAHaHa?pid=Api&P=0&h=180"
...
export default Home;
same dont change anything but change only image and keep a nice inage address 
note : dont change  excess plz
